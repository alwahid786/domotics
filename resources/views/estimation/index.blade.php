                        ...
                        @forelse($estimations as $estimation)
                            <tr>
                                ...
                                <td class="border px-4 py-2">
                                    ...
                                    <form id="delete-form-{{ $estimation->id }}" action="{{ route('estimations.destroy', $estimation->id) }}" method="POST" style="display: none;">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                                </td>
