<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <div>
                <a href="{{ route('room.create') }}" class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            ...
            @foreach ($rooms as $room)
                <tr>
                    ...
                    <td class="border px-4 py-2">
                        @if ($room->image)
                            <img src="{{ asset('storage/' . $room->image) }}" alt="{{ $room->name }}" class="img-thumbnail" width="100">
                        @endif
                    </td>
                    <td class="border px-4 py-2">
