            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                <div class="grid gap-6 lg:grid-cols-2 lg:gap-8 bg-white shadow p-4 rounded">
                    <div class="pt-3 sm:pt-5 mb-2 p-4" id="listaProdottiInPreventivo">
                        <!-- Search and Filter -->
                        <form action="<?php echo e(route('quotation.updateTitle',$quotation->id)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <div class="mb-4">
                                <label for="title" class="block text-sm font-medium text-gray-700 dark:text-gray-200">Titolo</label>
                                <input type="text" name="title" id="title" value="<?php echo e($quotation->title); ?>"
...
<?php endif; ?>
<?php /**PATH /home/MyDomotics/web/preventivi.mydomotics.it/public_html/resources/views/quotations/titlechange.blade.php ENDPATH**/ ?>