                ...
                <table class="table-auto w-full">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $estimations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $estimation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td class="border px-4 py-2"><img src="<?php echo e(asset($estimation->image)); ?>" alt="<?php echo e($estimation->image); ?>" class="w-16 h-16 object-cover"></td>
                                <td class="border px-4 py-2"><?php echo e($estimation->total); ?></a></td>
                                <td class="border px-4 py-2">
                                    <a href="<?php echo e(route('estimations.show', $estimation->id)); ?>" class="nline-flex items-center px-4 py-2 bg-gray-800 dark:bg-gray-200 border border-transparent rounded-md font-semibold text-xs text-white dark:text-gray-800 uppercase tracking-widest hover:bg-gray-700 dark:hover:bg-white focus:bg-gray-700 dark:focus:bg-white active:bg-gray-900 dark:active:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 transition ease-in-out duration-150">La mostra</a>
                                    ...
                                    <form id="delete-form-<?php echo e($estimation->id); ?>" action="<?php echo e(route('estimations.destroy', $estimation->id)); ?>" method="POST" style="display: none;">
                                        <?php echo csrf_field(); ?>
