     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                <?php echo e(__('Modifica prodotto')); ?> <?php echo e(old('name', $product->name)); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="text" name="code" id="code" value="<?php echo e(old('code', $product->code)); ?>"
                                   class="form-control border p-2 w-full" required>
                            <?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <textarea name="description" id="description"
                                      class="form-control border p-2 w-full"><?php echo e(old('description', $product->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <select name="status" id="status" class="form-control border p-2 w-full" required>
                                <option
                                    value="active" <?php echo e(old('status', $product->status) == 'active' ? 'selected' : ''); ?>>
                                    Active
                                </option>
                                <option
                                    value="inactive" <?php echo e(old('status', $product->status) == 'inactive' ? 'selected' : ''); ?>>
                                    Inactive
                                </option>
                            </select>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <select name="rooms[]" id="rooms" class="form-control border p-2 w-full" multiple="multiple"
                                ...
                                <?php $__currentLoopData = $rooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option
                                        value="<?php echo e($room->id); ?>" <?php echo e(in_array($room->id, old('rooms', $product->rooms->pluck('id')->toArray())) ? 'selected' : ''); ?>>
                            ...
                            <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="mb-2">
                                    <label for="role_<?php echo e($role->id); ?>"
                                           class="block text-sm font-medium"><?php echo e($role->name); ?> Price:</label>
                                    <input type="number" name="roles[<?php echo e($role->id); ?>]" id="role_<?php echo e($role->id); ?>"
                                           value="<?php echo e(old('roles.' . $role->id, $product->roles->find($role->id)->pivot->price ?? '')); ?>"
...
<?php endif; ?>
<?php /**PATH /home/MyDomotics/web/preventivi.mydomotics.it/public_html/resources/views/products/edit.blade.php ENDPATH**/ ?>