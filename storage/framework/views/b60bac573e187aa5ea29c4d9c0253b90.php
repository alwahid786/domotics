                        ...
                        <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td class="border px-4 py-2">
                                    ...
                                    <?php if($user->roles->pluck('name')->contains('Super Admin')): ?>
                                        <p>L'utente è Super Admin</p>
                                    <?php else: ?>
                                        <?php if($user->quotations()->count()<1): ?>
                                    <form action="<?php echo e(route('users.destroy', $user->id)); ?>" method="POST" enctype="multipart/form-data" style="display: inline-block;">
                                        <?php echo csrf_field(); ?>
                                        ...
                                        <?php else: ?><p>L'utente ha preventivi</p>
                                        <?php endif; ?>
                                    <?php endif; ?>
                                </td>
                            </tr>
...
<?php endif; ?>>
<?php /**PATH /home/MyDomotics/web/preventivi.mydomotics.it/public_html/resources/views/users/index.blade.php ENDPATH**/ ?>