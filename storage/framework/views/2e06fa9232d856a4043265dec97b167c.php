     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                <?php echo e(__('Modifica utente')); ?>

            </h2>
            <div>
                <a href="<?php echo e(route('users.index')); ?>" class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                ...
                <div class="container mx-auto px-4">
                    ...
                    <form action="<?php echo e(route('users.update', $user->id)); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="text" name="name" id="name" class="form-control border p-2 w-full" value="<?php echo e($user->name); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="email" name="email" id="email" class="form-control border p-2 w-full" value="<?php echo e($user->email); ?>" required>
...
<?php endif; ?>>
<?php /**PATH /home/Intuisco/web/mydomotics.intuisco.net/public_html/resources/views/users/edit.blade.php ENDPATH**/ ?>