...
<div class="container">
    ...
    <form action="<?php echo e(route('room.update', $room->id)); ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" name="name" id="name" class="form-control" value="<?php echo e($room->name); ?>" required>
        </div>
        <div class="form-group">
            <label for="description">Description</label>
            <textarea name="description" id="description" class="form-control"><?php echo e($room->description); ?></textarea>
        </div>
        <div class="form-group">
...
<?php endif; ?>
<?php /**PATH /Users/rayfanale/Sites/localhost/grazia/resources/views/room/edit.blade.php ENDPATH**/ ?>