                ...
                <table class="table-auto w-full">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td class="border px-4 py-2"><a href="<?php echo e(route('products.show', $product->id)); ?>"> <?php echo e($product->id); ?></a></td>
                                ...
                                <td class="border px-4 py-2">
                                    <form action="<?php echo e(route('quotation.add', [$product->id, $room])); ?>" method="POST" style="display:inline">
                                        ...
                                        <input type="text" value="1" required name="quantity" id="quantity">
...
<?php endif; ?>
<?php /**PATH /Users/rayfanale/Sites/localhost/grazia/resources/views/products/shop.blade.php ENDPATH**/ ?>